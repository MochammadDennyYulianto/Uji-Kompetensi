            ...
            <div class="container-fluid">
                <div class="row">
                                        ...
                                        @auth
											...
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item" >
														<a title="My Profile" href="{{ route('user.profile') }}">Profile Supervisor</a>
													</li>
													<li class="menu-item" >
                    ...
                    <div class="container">
                        <div class="mid-section main-info-area">
                            ...
                            <div class="wrap-logo-top left-section">
                                <a href="index.html" class="link-to-home"><img src="{{ asset('assets/images/route-66.png') }}" alt="mercado"></a>
                            </div>
                    ...
                    <div class="nav-section header-sticky ">
                        ...
                        <div class="primary-nav-section" style="margin-top: 5mm">
                            <div class="container">
